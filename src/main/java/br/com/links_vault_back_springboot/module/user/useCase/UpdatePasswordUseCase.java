...
public class UpdatePasswordUseCase {
    ...
    public UserResponseDTO execute(
        ...
        try {
            ...
            userEntityOptional.ifPresentOrElse(
                    user -> {
                        ...
                        userToUpdate.setPassword(
                                this.passwordEncoder.encode(updatePasswordRequestDTO.getPassword())
                        );
            ...
            throw new RuntimeException("Ocorreu um erro durante a alteração de senha, tente novamente.");
        }
    }
}
